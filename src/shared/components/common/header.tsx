...
function Brand(): React.ReactElement<any> {
  return (
...
function NavMenuItem({
  ...
  href,
  target,
}: NavMenuItemProps): React.ReactElement<any> {
  return (
...
function Menu(): React.ReactElement<any> {
...
function Actions(): React.ReactElement<any> {
  return (
